<?php namespace eastoriented\php\string\recipient\buffer\prefix;

use eastoriented\php\block;
use eastoriented\{ php, php\string\recipient\functor };
use eastoriented\php\test\{ variable\defined, recipient\ifTrue\functor as ifTrue };
